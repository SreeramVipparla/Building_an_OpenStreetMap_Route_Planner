...
# Introdution
This project involves the use  OpenStreetMap data and an IO2D map display code. The project also involves the extension ofthe IO2D map display code to use the  A* algorithm, the program will be able to find a path between two points on the map. On runing the project, you will be able to select the starting and ending areas on a city map, and your program will find
