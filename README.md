...
# Introdution
In this project that I have developed the  OpenStreetMap data and an IO2D map display code and also involves the extension of the IO2D map display code to use the  A* algorithm. The program will be able to find a path between two points on the map. On running the prograqm, you will be able to select the starting and ending areas on a city map, and your program will find
